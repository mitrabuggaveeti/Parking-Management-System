...
import { allBookings, allActiveBookings } from '../../actions/user.actions';

const AllActiveBookigs = (props) => {
...
const mapStateToProps = (state) => ({
    bookings: state.user.activeBookings
});

export default connect(mapStateToProps, { userBookingsAction: allActiveBookings })(AllActiveBookigs)
